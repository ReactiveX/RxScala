...
class CompletenessTest extends JUnitSuite {
  ...
  def correspondenceChanges = Map(
      ...
      "using(Func0[Resource], Func1[_ >: Resource, _ <: Observable[_ <: T]], Action1[_ >: Resource], Boolean)" -> "usingWithDisposeEagerly(=> Resource)(Resource => Observable[T], Resource => Unit, Boolean)",
